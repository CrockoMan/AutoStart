//Настройки драйвера MT12864

//Наш метод вывода
unsigned char PaintMetod_KS1080;
...
#define LCD_CONTROL_DDR     DDRA
            ...
            // LCD                   ATmega
#define LCD_A0      3   // DI  соединить с PA3     (LCD_CONTROL_PORT) 
#define LCD_RDWR    4   // RW  соединить с PA4
#define LCD_E       2   // E   соединить с PA2
#define LCD_E1      7   // CS1 соединить с PA7 
#define LCD_E2      6   // CS2 соединить с PA6
#define LCD_RES     5   // RST соединить с PA5

//Расположение флагов на шине LCD
#define BUSY    DB7
#define ONOFF   DB5
#define RESET   DB4

//Дефайны методов. Текст запомнить легче
#define MET_OR 0
#define MET_XOR 1 
#define MET_NOT_OR 2
#define MET_NOT_XOR 3
#define MET_CLS 4
#define MET_INVERSE 5
...
#define SetBitLCD(x,y) (x|=(1<<y))
#define ClrBitLCD(x,y) (x&=~(1<<y))
#define TestBitLCD(x,y) (x&(1<<y))   


flash const char sym[160][5] = 
{
